...
import DashboardOverview from "./pages/DashboardPages/adminDashboard/Overview";
import ManageUsers from "./pages/DashboardPages/adminDashboard/ManageUser";
import AppliedJobs from "./pages/DashboardPages/seekerDashboard/AppliedJobs";
import FavoriteJobs from "./pages/DashboardPages/seekerDashboard/FavoriteJobs";
import Myprofile from "./pages/DashboardPages/seekerDashboard/Myprofile";
import ProfileUpdate from "./pages/DashboardPages/seekerDashboard/ProfileUpdate";
