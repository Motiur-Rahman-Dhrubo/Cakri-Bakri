...
export default function JobDetails() {
  ...
  const handleApply = async () => {
    if (!user) {
      Swal.fire({
        ...
        text: "You need to log in to apply for a job. Proceed to login?",
        icon: "warning",
  ...
  const handleFavorite = async () => {
    if (!user) {
      Swal.fire({
        title: "Login Required",
        text: "You need to log in to add this job to favorites. Proceed to login?",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#0a4b61",
        cancelButtonColor: "#d33",
    ...
    if (!isSeeker) {
      return Swal.fire({
        title: "Access Denied",
        text: "Only job seekers can add jobs to their favorite list.",
        icon: "error",
      });
    }
    ...
    <section className="w-11/12 mx-auto py-10">
      <div className="bg-[#DBEAFE] rounded-xl shadow-lg p-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="space-x-2">
            ...
            <button
              ...
              className="btn border border-cb-primary bg-transparent text-cb-secondary hover:bg-cb-primary hover:text-cb-white"
            >
              Add To Favourite
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 text-gray-700">
          ...
          <p className="flex items-center gap-2">
            <FaCalendarAlt className="text-cb-primary" /> Posted: {job.postedDate}
          </p>
        </div>

        {/* Responsibilities */}
        <div className="mt-6">
          <h2 className="text-xl font-semibold text-cb-secondary">Responsibilities</h2>
        ...
        {/* Qualifications */}
        <div className="mt-6">
          <h2 className="text-xl font-semibold text-cb-secondary">Qualifications</h2>
          <ul className="list-disc list-inside text-gray-700 mt-2">
        ...
        {/* Perks */}
        <div className="mt-6">
          <h2 className="text-xl font-semibold text-cb-secondary">Perks & Benefits</h2>
          <ul className="list-disc list-inside text-gray-700 mt-2">
        ...
        {/* Skills */}
        <div className="mt-6">
          <h2 className="text-xl font-semibold text-cb-secondary">Skills Required</h2>
