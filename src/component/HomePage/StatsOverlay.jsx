...
export default function StatsOverlay() {
  return (
    <div className="relative w-full bg-cb-card text-primary-content py-4 md:py-8">
      <h2 className="text-center text-cb-primary text-4xl font-bold">Our Comany Statistics</h2>
